...
export default function Tasks(props: TypeTask) {
  ...
  return (
    <div
      className={contextColor.color ? "tasks_light tasks" : "tasks_dark tasks"}
    >
      {props.task.map((task: TypeTaskFromJson) => (
        <div
          key={task.id}
          className={contextColor.color ? "task_light task" : "task_dark task"}
        >
          {editId === task.id ? (
            <div className="task__editing">
              ...
              <button  className={
                  ...
                  } onClick={() => handlerSave(task.id)}>Save</button>
            </div>
          ) : (
            <div className="task__content">
              ...
              <div className="task__buttons">
                ...
                <input className="task__checkbox" type="checkbox" onChange={handlerCheckBox} />
              </div>
            </div>
          )}
        </div>
